				...
				<div class="row">
					...
					<div class="col-md-4 animate-box">
						<div class="classes">
							...
							<div class="desc">
								<h3><a href="subject_detail.html">Chủ đề 2</a></h3>
								<p>Pointing has no control about the blind texts it is an almost unorthographic life</p>
								<p><i class="fa fa-eye"></i> 10</p>
							</div>
						</div>
					...
					<div class="col-md-4 animate-box">
						<div class="classes">
							...
							<div class="desc">
								<h3><a href="subject_detail.html">Chủ đề 3</a></h3>
								<p>Pointing has no control about the blind texts it is an almost unorthographic life</p>
								<p><i class="fa fa-eye"></i> 10</p>
							</div>
						</div>
					...
					<div class="col-md-4 animate-box">
						<div class="classes">
							...
							<div class="desc">
								<h3><a href="subject_detail.html">Chủ đề 4</a></h3>
								<p>Pointing has no control about the blind texts it is an almost unorthographic life</p>
								<p><i class="fa fa-eye"></i> 10</p>
							</div>
						</div>
					...
					<div class="col-md-4 animate-box">
						<div class="classes">
							...
							<div class="desc">
								<h3><a href="subject_detail.html">Chủ đề 5</a></h3>
								<p>Pointing has no control about the blind texts it is an almost unorthographic life</p>
								<p><i class="fa fa-eye"></i> 10</p>
							</div>
						</div>
					...
					<div class="col-md-4 animate-box">
						<div class="classes">
							...
							<div class="desc">
								<h3><a href="subject_detail.html">Chủ đề 6</a></h3>
								<p>Pointing has no control about the blind texts it is an almost unorthographic life</p>
								<p><i class="fa fa-eye"></i> 10</p>
							</div>
						</div>
					...
					<div class="col-md-3 colorlib-widget">
						...
						<p>
							<ul class="colorlib-footer-links">
								<li>
									<a href="about.html">
										<i class="icon-check"></i> About Us</a>
								</li>
								<li>
									<a href="courses.html">
										<i class="icon-check"></i> Study</a>
								</li>
								<li>
									<a href="news.html">
										<i class="icon-check"></i> News</a>
								</li>
								<li>
									<a href="contact.html">
										<i class="icon-check"></i> Contact</a>
								</li>
							</ul>
						</p>
					</div>
